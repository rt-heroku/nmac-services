...
/**
 * Persistent class for entity stored in table "nmac_pymnts"
 *
...
@Entity
@Table(name="nmac_pymnts", schema="public" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="NmacPymnts.countAll", query="SELECT COUNT(x) FROM NmacPymnts x" )
} )
public class NmacPymnts implements Serializable
{
    ...
    public NmacPymnts update(NmacPymnts a) {
		this.id = a.id;
        this.usrId = a.usrId;
